// MainController.cs - MainController
//
...
namespace MonoWorks.Studio
{
	...
	/// <summary>
	/// The controller class for the main Studio window.
	/// </summary>
	public class MainController : AbstractController<MainWindow>
	{
		/// <summary>
		/// Default constrcutor.
		/// </summary>
...
#region File I/O
		...
		public void NewFile()
		{
			DocWindow docWindow = new DocWindow(window);
			window.DocArea.AddSubWindow(docWindow);
		...
		public void OpenScriptEditor()
		{
			...
			MonoWorks.Editor.Window window = new MonoWorks.Editor.Window();
...
#region Edit
		...
		public void Undo()
		{
			...
			Window.CurrentDocWindow.Refresh();
		}
